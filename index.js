...
client.login('NzY5MzMwMjExMTU3ODM1Nzg0.X5Nclw.AXG-thwTfbYH00FAwRKwW9deBH4');
...
client.user.setActivity(`${PREFIX}help , Guilds ${client.guilds0.cache.size}`);
...
var channel = client.channels.cache.get('837692597114765322') //ايدي الشات
